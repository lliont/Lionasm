...
INT4T4	DA		PUTC
INT4T5	DA		PSTR
INT4T6	DA		SCROLL2   ; Scrolls screen 1 char (8 points) up
INT4T7	DA		INT4R     ; NOT Defined
INT4T8	DA		INT4R     ; NOT Defined
INT4T9	DA		DIV       ; Div A2 by A1 res in A1,A0
INT4T10	DA		KEYB     ; converts to ascii codes from serial keyboerd
...
DIV5:		BTST		A0,14
		...
		SLL		A0,1
		JMP		DIV5
DIV6:		MOV		(NN),A1 ; store no of shifts
		MOVI		B0,0
		MOV		A1,A3
DIV7:		BTST		A1,14
		JNZ		DIV12
