...
INT5T0	DA		FMULT	   ; Fixed point multiply
INT5T1	DA		FDIV	   ; Fixed point divide 
...
; Div A2 by A1 res in A1 (FRAC2),   restoring division 9/5/2017
...
FDIV3:	MOV		A3,(FRAC1)
		...
		SETX		26            ; shift dividend as left as possible
FDC1:		BTST		A2,15
		JNZ		FDC2
		SLL		A2,1
		SLL		A4,1
