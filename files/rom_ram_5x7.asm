...
LAB1:		SUB		A1,32    
		...
		MOV.B		A0,(YY)
		MOV		A1,A0
		SLL		A0,7      ;128            ;204    ; 34 perline * 8  * 6 / 8 bytes
		SLL		A1,6	   ;+64
		ADD		A0,A1
		SRL		A1,3	   ;+8
		ADD		A0,A1
...
C48_49	DB	$7C,$64,$54,$4C,$7C,0,   $48,$7C,$40,0,0,0
...
C94_95	DB	0,1,0,1,0,0,      $40,$40,$40,$40,$40,$40
C96_123	DB	0,1,0,0,0,0,0,   $10,$07,$44,0,0,0
C124_125 	DB	$6C,0,0,0,0,0,  $44,$7c,16,0,0,0
C126  	DB	2,1,2,1,0,0
