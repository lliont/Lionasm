...
ROMEND:
; Charcter table Font
;CTABLE	DB	0,0,0,0,0,0,0,0,96,250,96,0  ; !
;C34_35	DB	0,224,192,0,224,192,0,36,126,36,126,36 ; # "
;C36_37	DB	0,36,212,86,72,0,0,198,200,16,38,198  ; $ %
;C38_39      DB    0,108,146,106,4,10,0,0,224,192,0,0  ; & '
;C40_41	DB	0,0,124,130,0,0,0,0,130,124,0,0  ; ( )
;C42_43	DB	0,16,124,56,124,16,0,16,16,124,16,16 ; * +
;C44_45	DB	0,0,7,6,0,0,0,16,16,16,16,16  ; , -
;C46_47	DB	0,0,6,6,0,0,0,4,8,16,32,64  ; . /
;C48_49	DB	0,124,138,146,162,124,0,0,66,254,2,0  ; 0 1
;C50_51	DB	0,70,138,146,146,98,0,68,146,146,146,108 ; 2 3
;C52_53	DB	0,24,40,72,254,8,0,244,146,146,146,140   ; 4 5
;C54_55	DB	0,60,82,146,146,12,0,128,142,144,160,192 ; 6 7
;C56_57	DB	0,108,146,146,146,108,0,96,146,146,148,120 ; 8 9
;C58_59	DB	0,0,54,54,0,0,0,0,55,54,0,0 ; : ;
;C60_61	DB	0,16,40,68,130,0,0,36,36,36,36,36 ; < =
;C62_63	DB	0,0,130,68,40,16,0,64,128,154,144,96 ; > ?
;C64_65	DB	0,124,130,186,170,120,0,126,136,136,136,126  ;@  A
;C66_67	DB	0,254,146,146,146,108,0,124,130,130,130,68 ;B C
;C68_69	DB	0,254,130,130,130,124,0,254,146,146,146,130 ;D E
;C70_71	DB	0,254,144,144,144,128,0,124,130,146,146,94 ;F G
;C72_73	DB	0,254,16,16,16,254,0,0,130,254,130,0  ; H I
;C74_75	DB	0,12,2,2,2,252,0,254,16,40,68,130  ; J K
;C76_77	DB	0,254,2,2,2,2,0,254,64,32,64,254  ;  L M
;C78_79	DB	0,254,64,32,16,254,0,124,130,130,130,124 ; N O
;C80_81	DB	0,254,144,144,144,96,0,124,130,138,132,122 ; P Q
;C82_83	DB	0,254,144,144,152,102,0,100,146,146,146,76 ; R S
;C84_85	DB	0,128,128,254,128,128,0,252,2,2,2,252 ; T U
;C86_87	DB	0,248,4,2,4,248,0,252,2,60,2,252  ;V W
;C88_89	DB	0,198,40,16,40,198,0,224,16,14,16,224 ;X Y
;C90_91	DB	0,142,146,162,194,0,0,0,254,130,130,0  ; Z [
;C92_93	DB	0,64,32,16,8,4,0,0,130,130,254,0  ;  \ ]
;C94_95	DB	0,32,64,128,64,32,1,1,1,1,1,1 ;  ^ _
;C96_97	DB	0,0,192,224,0,0,0,4,42,42,42,30       ; ` a
...
;C122_123    DB    0,38,42,42,50,0,0,16,124,130,130,0 ; z {
;C124_125	DB	0,0,0,238,0,0,0,0,130,130,124,16 ; | }
;C126_127	DB	0,64,128,64,128,0,0,60,100,196,100,60 ; ~ square
