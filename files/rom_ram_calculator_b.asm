...
STREXIT:	POP		A1
		RETI
;----------------------------------------
SCROLL:	PUSHI                       ; Scroll text buffer 1 line up
		SETI		322
		MOV		A0,TEXTBUF
		MOV		A1,A0
		ADD		A1,34
...
CL6:		MOV.B		(OP),A1
		...
		JZ		ERR1
		MOV.B		A1,(OP)
		CMP.B		A1,43     ; is it a plus +
		JNZ		CL10
		JSR		ADDIT
		JMP		CL9
CL10:		CMP.B		A1,45		; is it a -
		JNZ		CL11
		JSR		SUBIT
		JMP		CL9
CL11:		CMP.B		A1,42     ; is it a plus *
		JNZ		CL12
		JSR		MULIT
		JMP		CL9
CL12:		CMP.B		A1,47		; is it a /
		JNZ		ERR1
		JSR		DIVIT
CL9:		JSR		DISPL
		RET
