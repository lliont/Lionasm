...
YY		DB		0
		JMP		START	
LLINE		DS		50
TITLE		TEXT		"Lion System  Int Calc!"
		DW		0
START:	MOV		A2,$0E06
		MOV		A1,TITLE
		MOVI		A0,5      ; Print Title
		INT		4
		MOV		A1,65169 ; Set line 26 color
		MOV.B		(A1),80  
		SETI		130
		MOV		A1,81	
		MOV		A2,60
...
DI1:		MOV		A1,A3
		MOV		A0,9
		INT		4
		CMP		A1,0    ; IS RESULT NON ZERO
		JNZ		DI2
		CMP		A3,1    ; IS IT THE LAST DIGIT
		JZ		DI2     
		CMP		A4,0    ; IS IT LEADING ZERO
		JZ		DI3
DI2:		MOVI		A4,1
		ADD		A1,48
		JSR		PCHI
...
GETNUM:	PUSHI
		JSR		ESP  ; eat spaces
		MOVI		A4,0
		MOV.B		(SIGN),0   ; A4 will contain the num of digits
		MOV		A1,(STRI)
		ADD		A1,LLINE
		MOV.B		A0,(A1)
