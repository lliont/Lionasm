...
FDIV:		STI	
		...
		ADC		A1,0
		MOV		(FRAC1),A4
FDIV2:	BTST		A2,15   ; check if neg and convert 
		JZ		FDIV3
		NOT		A2
		MOV		A4,(FRAC2)
		NOT		A4
...
FDC2:		PUSHI	
		...
		SLL		A2,1  ; it's one bit shorter
		SLL		A4,1 
		ADC		A2,0
FD_INTER:
		SLL		A4,1   ; Shift left AQ
		PUSH		SR
		SLL		A2,1
		PUSH		SR
		SLL		A3,1
...
FDLP:		SLL		A2,1
		...
		POP		A0
		BTST		A0,15
		JZ		FDIVEND     ; Check result sign
		NOT		A1
		NOT		A4
		INC		A4
		ADC		A1,0
FDIVEND:	MOV		(FRAC1),A4
		POPI
		POP		A4
		POP		A3
		RETI
